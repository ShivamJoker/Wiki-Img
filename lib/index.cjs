...
Object.defineProperty(exports, "getWikiImg", {
    enumerable: true,
    get: ()=>getWikiImg
});
const _nodeHttps = require("node:https");
    ...
    return new Promise((resolve, reject)=>{
        ...
        const imgreq = (0, _nodeHttps.get)({
            ...
            if (res.statusCode == 200) {
                const imgPath = _nodePath.default.resolve(dir, `${page.key}.${fileExt}`);
                const fstream = (0, _nodeFs.createWriteStream)(imgPath, {
                    encoding: "binary"
                });
 ...
 */ const getWikiImg = (query, dir = "./")=>{
    return new Promise((resolve, reject)=>{
        const path = "https://api.wikimedia.org/core/v1/wikipedia/en/search";
        const imgreq = (0, _nodeHttps.get)(`${path}/title?q=${query}&limit=1`);
